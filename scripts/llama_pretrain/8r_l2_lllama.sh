...
srun torchrun \
    ...
    train.py \
    --model 'LatentLlama' \
    --exp_type 'lllama_8rgb_2_pretrain' \
    --backbone_path storage/shared/checkpoints/lllama_8rgb_2_pretrain/lpixel_pretrain/LatentLlama/20231115-025732/80000/backbone \
    --is_continue_train true \
    --dataset_paths /work/sc118/sc118/shared/datasets/bookAndwiki \
    --compressor_path /work/sc118/sc118/yintaotai/msc_project/storage/autoencoders/r4h8c3hc16g8 \

...
export BACKBONE_PATH='/work/sc118/sc118/yintaotai/msc_project/storage/shared/checkpoints/lllama_8rgb_2_pretrain/lpixel_pretrain/LatentLlama/20231116-011922/100000/backbone'
export COMPRESSOR_PATH='/work/sc118/sc118/yintaotai/msc_project/storage/autoencoders/r4h8c3hc16g8'
export COMPRESSOR_NAME='CNNAutoencoder'
export BATCH_SIZE=8
export MAX_NUM_PATCH=720
export PATCH_LEN=2
export WANDB__SERVICE_WAIT=300

export EXP_NAME='lllama_2_rgb'

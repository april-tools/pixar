...
srun torchrun \
    ...
    train.py --model LatentLlamaForSequenceClassification \
        ...
        --optim AdamW --finetune_task glue --glue_task stsb --lr 3e-5 --beta1 0.9 --beta2 0.95 --decay 0.01 --total_steps 2000 --eval_freq 100 --save_freq 100 --warm_up_step 100 --best_save_freq 200 --seed 42 --batch_size 128 \
...
srun torchrun \
    ...
    train.py --model LatentLlamaForSequenceClassification \
        --exp_type ${EXP_NAME}_stsb_ \
        --backbone_path $BACKBONE_PATH \
        --optim AdamW --finetune_task glue --glue_task stsb --lr 3e-5 --beta1 0.9 --beta2 0.95 --decay 0.01 --total_steps 2000 --eval_freq 100 --save_freq 100 --warm_up_step 100 --best_save_freq 200 --seed 42 --batch_size 256 \
        --sub_size 16 --font_file PixeloidSans-mLxMm.ttf --dpi 80 --pixels_per_patch 8 \
        --patch_len $PATCH_LEN \
        --max_seq_length $MAX_NUM_PATCH --num_channel 1 --binary $BINARY --rgb $RGB --mix_precision fp16 --half_coder true --mp_workers 8 \
        --num_gpu_per_node $GPU_PER_NODE \
        --num_node $NUM_NODES

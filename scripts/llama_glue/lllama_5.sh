...
export BACKBONE_PATH='/work/sc118/sc118/yintaotai/msc_project/storage/shared/checkpoints/100kModels/lllama_5_100k/backbone'
export COMPRESSOR_PATH='/work/sc118/sc118/yintaotai/msc_project/storage/compressors/CNNAutoencoders/r4h8c1hc16g8b'
export COMPRESSOR_NAME='CNNAutoencoder'
export BATCH_SIZE=8
export MAX_NUM_PATCH=1800
export PATCH_LEN=5
